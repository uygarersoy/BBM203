...
public:
    ...
    void set_data(double data, int i, int j) const; // Setter function to update the data at the index (i, j)
    int get_height() const; // Getter function to access the height of the image
    int get_width() const; // Getter function to access the width of the image
